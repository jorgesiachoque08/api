...
class TaskPlaces extends \Phalcon\Mvc\Model
{
    ...
    public function initialize()
    {
        ...
        $this->hasMany('id', 'EvidenceTaskPlaces', 'id_task_places', array('alias' => 'EvidenceTaskPlaces','params' => ['order' => 'id DESC']));
        $this->hasMany('id', 'TaskHistory', 'task_places_id', array('alias' => 'TaskHistory'));
        $this->hasMany('id', 'Track', 'task_places_id', array('alias' => 'Track'));
        $this->belongsTo('id', 'TaskPlacesComplement', 'id_task_place', array('alias' => 'TaskPlacesComplement'));
        $this->belongsTo('task_id', 'Task', 'id', array('alias' => 'Task'));
        $this->belongsTo('paiment_type', 'TypeTaskPagoOrder', 'id', array('alias' => 'PaimentType'));
        
        
        $this->belongsTo('store_id', 'ClientPoint', 'id', array('alias' => 'ClientPoints'));
    }
