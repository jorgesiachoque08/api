...
class Task extends \Phalcon\Mvc\Model {
    ...
    public function initialize() {
        ...
        $this->hasMany('id', 'TaskPlaces', 'task_id', array('alias' => 'TaskPlaces', 'params' => ['order' => 'tipo_task_places ASC']));
        $this->hasMany('id', 'Track', 'task_id', array('alias' => 'Track'));
        $this->hasMany('id', 'TaskToken', 'task_id', array('alias' => 'TaskToken'));
        $this->hasMany('id', 'TaskInvoices', 'task_id', array('alias' => 'TaskInvoices'));

        $this->hasMany('id', 'HistoryService', 'task_id', array('alias' => 'HistoryService'));
        $this->belongsTo('id', 'TaskDetail', 'task_id', array('alias' => 'TaskDetail'));
        $this->hasMany('cc', 'ClientPoint', 'id_point_client', array('alias' => 'Points'));
        ...
        $this->belongsTo('usercreate', 'TblUsers', 'id', array('alias' => 'TblUsersCreate'));
        $this->belongsTo('tipo_segmentacion_id', 'TypeCaracteristicaRecursos', 'id', array('alias' => 'Segmentation'));
    }
